...
model = RegMods.convolutional_neural_network_2d(features.feature_shape, labels.label_shape, activation="linear",
                                                layers=(64, 256, 384, 384, 256, 256, 512), padding="same", kernel_shape=5)

experiment = Experiment(parameters, "3D_64_256_2x384_256_256_512_ks5", model, dataset, features, labels,
                        callbacks)
