...
inputPath = "C:/Users/Huw/PycharmProjects/parmec_agr_ml_surrogate/Houses-dataset/Houses Dataset/"
...
preds_train = model.predict(trainImagesX)

plt.scatter(trainY, preds_train.flatten())
plt.show()
