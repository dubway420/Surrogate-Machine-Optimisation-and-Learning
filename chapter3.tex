...
% Hard computing - hard coded relationships between inputs (x) and outputs (y)

	% Power = f{x}

% Example: predicting reactor power from core configuration

	% Configuration factors:
	
		% Average control rod insertion depth - negative correlation with power - non linear
		% Fuel enrichment - positive correlation with power - linear
		% Flow rate of coolant - positive, drop off with high power
		% Age of core - lightly positive, mostly neutral
		% 
