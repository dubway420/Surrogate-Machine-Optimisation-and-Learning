...
% HAVE A LINEAR COMBINATION EQUATION

% P = f{x1} + f{x2} + f{x3} + f{x4} 

% Say that individual functions may not be linear and may also rely on the vaue of each other in some complicated way
