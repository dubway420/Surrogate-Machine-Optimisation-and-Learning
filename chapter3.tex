...
%Multiple outputs - the ability 
%
%Fully connected - both ways
%
%Advantage of neural networks - can model complex phenomena with non linear relationships in the data.
%
%Weights for each node
%
%There are four input features, comparable to the four inputs described in the example at the start of the  After the input layer, we have two hidden layers, the first with 3 nodes, the second with two nodes. Following the second hidden 
